...
//  Display the course home page.
	...
	if (!is_enrolled($context)) {
		...
		echo html_writer::start_tag('form', array('class' => 'send_query', 'action' => $my_form_action, 'method' => 'post'));
		echo html_writer::empty_tag('input', array('type' => 'hidden', 'name' => 'sent_course', 'value' => $get_course_name));
		echo html_writer::empty_tag('input', array('type' => 'submit', 'value' => $send_button_value));
		echo html_writer::end_tag('form');	
	}
	/* my code */
